                              ...
                              <div class="jumbotron jumbotron-fluid">
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <hr>
                                          <div class="container">
                                              <h1 class="display-3 text-center">Metals</h1>
                                          </div>
                                          <hr>
        ...
        <!-- This section is for the animated images-->
                ...
                <div class="wrap">
          	        <div class="tile mx-auto">
          	            <img src='images/aluminum-foil.jpg'/>
                        <?php $foil = "Aluminum Foil"; ?>
          	            <div class="text">
                		        <h1 style="font-size:38px">Aluminum Foil</h1>
                		        <h2 class="animate-text"><?php getItemRecyclable($foil); ?></h2>
                		        <p class="animate-text"><?php getItemSpecifics($foil); ?></p>
                		        <div class="dots">
                		            <span></span>
                		            <span></span>
                		            <span></span>
                    ...
                    <div class="tile mx-auto">
                        <img src='images/tin-can.jpg'/>
                        <?php $tin = "Tin Cans"; ?>
                        <div class="text">
                            <h1>Tin/Steel Cans</h1>
                            <h2 class="animate-text"><?php getItemRecyclable($tin); ?></h2>
                		        <p class="animate-text"><?php getItemSpecifics($tin); ?></p>
                            <div class="dots">
                                <span></span>
                                <span></span>
                                <span></span>
                    ...
                    <div class="tile mx-auto">
                        <img src='images/aluminum-cans.jpg'/>
                        <?php $alu = "Aluminum Cans"; ?>
                        <div class="text">
                            <h1 style="font-size:36px">Aluminum Cans</h1>
                            <h2 class="animate-text"><?php getItemRecyclable($alu); ?></h2>
                		        <p class="animate-text"><?php getItemSpecifics($alu); ?></p>
                            <div class="dots">
                                <span></span>
                                <span></span>
                                <span></span>
